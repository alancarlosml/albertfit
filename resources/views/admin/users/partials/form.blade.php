...
<div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
    ...
    @if (!isset($user))
    <div>
        <label for="establishment" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Estabelecimento</label>
        <select id="establishment" name="establishment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
    ...
    <div class="sm:col-span-2">
        <label class="inline-flex items-center cursor-pointer">
            <input type="checkbox" value="1" class="sr-only peer" name="active" {{ old('active', $user->active ?? false) ? 'checked' : '' }}>
