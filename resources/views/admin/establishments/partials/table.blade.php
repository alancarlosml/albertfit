    ...
    <tbody>
        @foreach($establishments as $establishment)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="py-4 px-6">
                    <div class="flex items-center">
                        <div class="inline-block w-4 h-4 mr-2 rounded-full {{ $establishment->active ? 'bg-green-700' : 'bg-red-700' }}"></div>
                        <span>{{ $establishment->active ? 'Ativo' : 'Inativo' }}</span>
                    </div>
                </td>
                <td class="px-6 py-4 flex items-center">
                    <a href="#" onclick="viewEstablishment(event, {{ $establishment->id }})" class="font-medium mr-3 text-green-600 dark:text-green-500 hover:underline">Gerenciar</a>
                    <a href="#" onclick="editEstablishment(event, {{ $establishment->id }})" class="font-medium mr-3 text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
