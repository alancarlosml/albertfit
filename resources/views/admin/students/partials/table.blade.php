            ...
            <tr
                ...
                <td class="p-4 w-4">
                    ...
                    <input type="checkbox"
                            ...
                            :checked="selectAll"> <label :for="`checkbox-table-search-` + student.id" class="sr-only">checkbox</label>
                    </div>
                </td>
                <th scope="row"
                ...
                <td class="py-4 px-6">
                    <div class="flex items-center">
                        <div class="inline-block w-4 h-4 mr-2 rounded-full" x-bind:class="student.active ? 'bg-green-700' : 'bg-red-700'"></div>
                        <span x-text="student.active ? 'Ativo' : 'Inativo'"></span>
                    </div>
                </td>
                <td class="px-6 py-4 flex items-center">
                    <a href="#" x-on:click="viewStudent($event, student.id)" class="font-medium mr-3 text-green-600 dark:text-green-500 hover:underline">Detalhes</a>
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <button data-modal-hide="popup-modal"  x-on:click="deleteStudent($event, student.id)" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                        Sim, tenho certeza
                                    </button>
