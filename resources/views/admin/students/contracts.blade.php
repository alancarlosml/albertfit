<x-app-layout>
    ...
    <section class="mt-12">
        <div class="py-8 mx-auto w-full">
            ...
            <h3 class="text-2xl font-normal text-gray-900 dark:text-white">{{ $student->name }}</h3>
            <h3 class="text-2xl font-normal text-gray-900 dark:text-white">{{ $establishment->name }}</h3>
            <div class="mx-auto">
                <div class="mx-auto w-full">
                    <div class="relative overflow-hidden">
                        ...
                        {{-- início modal vinculação student-contract --}}
                                        ...
                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <select id="payment_type" name="payment_type"
                                                    ...
                                                    <option value="debito">Debido</option>
                        ...
                        {{-- fim modal vinculação student-contract --}}
